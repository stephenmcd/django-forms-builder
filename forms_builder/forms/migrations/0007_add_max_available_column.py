...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('forms_field', 'max_available',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Field.order'
        db.delete_column('forms_field', 'max_available')
    ...
    models = {
        u'forms.field': {
            ...
            'max_available': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'blank': 'True'}),
